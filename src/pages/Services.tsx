...
const boatOrganizations: BoatOrganization[] = [
  ...
  },
  {
    ...
    description:
      "Hayatınızın en önemli sorusunu sormak için romantik bir ortam.",
  ...
  },
  {
    ...
    description:
      "Şirket toplantıları ve etkinlikler için özel tekne organizasyonu.",
  ...
  },
  {
    ...
    title: "Özel Catering",
    description:
      "Denizde lezzetli yemekler ve içecekler eşliğinde keyifli zaman.",
